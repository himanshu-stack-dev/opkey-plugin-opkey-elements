...
\Breakdance\ElementStudio\registerElementForEditing(
    "BreakdanceCustomElements\\Columnstwostats",
    \Breakdance\Util\getdirectoryPathRelativeToPluginFolder(__DIR__)
);

class Columnstwostats extends \Breakdance\Elements\Element
{
    ...
    {
        return '2 Columns + Stats';
    }

    static function className()
    {
        return 'autogenerated-bce-columnstwostats';
    }
