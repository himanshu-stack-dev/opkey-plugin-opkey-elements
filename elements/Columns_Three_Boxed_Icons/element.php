...
\Breakdance\ElementStudio\registerElementForEditing(
    "BreakdanceCustomElements\\Columnsthreeboxedicons",
    \Breakdance\Util\getdirectoryPathRelativeToPluginFolder(__DIR__)
);

class Columnsthreeboxedicons extends \Breakdance\Elements\Element
{
    ...
    {
        return '3 Columns Boxed + Icons';
    }

    static function className()
    {
        return 'autogenerated-bce-columnsthreeboxedicons';
    }
