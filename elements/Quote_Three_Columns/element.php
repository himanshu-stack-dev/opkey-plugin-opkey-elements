...
\Breakdance\ElementStudio\registerElementForEditing(
    "BreakdanceCustomElements\\Quotethreecolumns",
    \Breakdance\Util\getdirectoryPathRelativeToPluginFolder(__DIR__)
);

class Quotethreecolumns extends \Breakdance\Elements\Element
{
    ...
    {
        return 'Quote 3 Columns';
    }

    static function className()
    {
        return 'autogenerated-bce-quotethreecolumns';
    }
