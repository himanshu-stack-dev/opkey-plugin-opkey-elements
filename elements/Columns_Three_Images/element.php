...
\Breakdance\ElementStudio\registerElementForEditing(
    "BreakdanceCustomElements\\Columnsthreeimages",
    \Breakdance\Util\getdirectoryPathRelativeToPluginFolder(__DIR__)
);

class Columnsthreeimages extends \Breakdance\Elements\Element
{
    ...
    {
        return '3 Columns + Images';
    }

    static function className()
    {
        return 'autogenerated-bce-columnsthreeimages';
    }
