...
\Breakdance\ElementStudio\registerElementForEditing(
    "BreakdanceCustomElements\\Columnstwoboxedicons",
    \Breakdance\Util\getdirectoryPathRelativeToPluginFolder(__DIR__)
);

class Columnstwoboxedicons extends \Breakdance\Elements\Element
{
    ...
    {
        return '2 Columns Boxed + Icons';
    }

    static function className()
    {
        return 'autogenerated-bce-columnstwoboxedicons';
    }
