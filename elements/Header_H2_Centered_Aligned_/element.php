...
\Breakdance\ElementStudio\registerElementForEditing(
    "BreakdanceCustomElements\\Headerh2centeredalinged",
    \Breakdance\Util\getdirectoryPathRelativeToPluginFolder(__DIR__)
);

class Headerh2centeredalinged extends \Breakdance\Elements\Element
{
    ...
    {
        return 'Header H2 Centered Aligned';
    }

    static function className()
    {
        return 'autogenerated-bce-headerh2centeredalinged';
    }
