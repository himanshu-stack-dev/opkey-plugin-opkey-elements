...
\Breakdance\ElementStudio\registerElementForEditing(
    "BreakdanceCustomElements\\Columnstwoimages",
    \Breakdance\Util\getdirectoryPathRelativeToPluginFolder(__DIR__)
);

class Columnstwoimages extends \Breakdance\Elements\Element
{
    ...
    {
        return '2 Columns + Images';
    }

    static function className()
    {
        return 'autogenerated-bce-columnstwoimages';
    }
