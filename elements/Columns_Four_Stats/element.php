...
\Breakdance\ElementStudio\registerElementForEditing(
    "BreakdanceCustomElements\\Columnsfourstats",
    \Breakdance\Util\getdirectoryPathRelativeToPluginFolder(__DIR__)
);

class Columnsfourstats extends \Breakdance\Elements\Element
{
    ...
    {
        return '4 Columns + Stats';
    }

    static function className()
    {
        return 'autogenerated-bce-columnsfourstats';
    }
