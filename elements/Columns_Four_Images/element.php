...
\Breakdance\ElementStudio\registerElementForEditing(
    "BreakdanceCustomElements\\Columnsfourimages",
    \Breakdance\Util\getdirectoryPathRelativeToPluginFolder(__DIR__)
);

class Columnsfourimages extends \Breakdance\Elements\Element
{
    ...
    {
        return '4 Columns + Images';
    }

    static function className()
    {
        return 'autogenerated-bce-columnsfourimages';
    }
