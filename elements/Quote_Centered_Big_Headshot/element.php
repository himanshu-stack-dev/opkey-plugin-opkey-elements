...
\Breakdance\ElementStudio\registerElementForEditing(
    "BreakdanceCustomElements\\Quotecenteredbigheadshot",
    \Breakdance\Util\getdirectoryPathRelativeToPluginFolder(__DIR__)
);

class Quotecenteredbigheadshot extends \Breakdance\Elements\Element
{
    ...
    {
        return 'Quote + Big Headshot';
    }

    static function className()
    {
        return 'autogenerated-bce-quotecenteredbigheadshot';
    }
...
'onMountedElement' => [['script' => 'window.BreakdanceSwiper().update({
  ...
  paginationSettings:{{ design.slider.pagination|json_encode }},
    ...
    {
        return [['accepts' => 'string', 'path' => 'content.content.text'], ['accepts' => 'string', 'path' => 'content.content.link.url'], ['accepts' => 'string', 'path' => 'content.buttons.add_button.button.text'], ['accepts' => 'string', 'path' => 'content.buttons.add_button.button.link.url'], ['accepts' => 'string', 'path' => 'content.buttons.secondary_button.text'], ['accepts' => 'string', 'path' => 'content.buttons.secondary_button.link.url'], ['accepts' => 'string', 'path' => 'content.email.embed_code.text'], ['accepts' => 'string', 'path' => 'content.email.embed_code.link.url'], ['accepts' => 'string', 'path' => 'content.content.slides.link_to_case_study.text'], ['accepts' => 'string', 'path' => 'content.content.slides.link_to_case_study.link.url']];
    }
